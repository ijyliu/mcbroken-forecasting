...
- **ARIMA**: Auto-Regressive Integrated Moving Average model with seasonal components, exogenous regressors (technically, SARIMAX)
- **Exponential Smoothing**: Holt-Winters damped trend model with seasonality
